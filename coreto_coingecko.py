...
price = soup.find(class_="col-12 row p-0 m-0").find(class_="no-wrap").text
pct = None
...
if flag:
    ...
    msg = f"Lapi 🐰❤️ Coreto's price is {price}. Price changed {sgn}${round(diff,5)} since last text message. Scraped @ {current_time}"
